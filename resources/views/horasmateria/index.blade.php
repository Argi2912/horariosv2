                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-head">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card-tittle">
                                        <h3 class="text-center">Horarios Materia</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="row ml-3">
                            ...
                            <div class="row ml-3">
                                <div class="col-md-6">
                                    <a href="{{ route('horasmateria.create') }}" class="btn btn-warning">Ingresar</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($materias as $materia)
                                        <tr>
                                            ...
                                            <td>
                                                @can('editar')
                                                    <a href="{{ route('horasmateria.edit', $materia->id) }}"
                                                        class="btn btn-info">Editar</a>
                                                @endcan
                                                @can('borrar')
                                                    {!! Form::open([
                                                        'method' => 'DELETE',
                                                        'route' => ['horasmateria.destroy', $materia->id],
