                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-head">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card-tittle">
                                        <h3 class="text-center">Aulas en el Sistema</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="row ml-3">
                            ...
                            <div class="row ml-3">
                                <div class="col-md-6">
                                    <a href="{{ route('aulas.create') }}" class="btn btn-warning">Nueva Aula</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    @foreach ($aulas as $aula)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endcan
                                                @can('borrar')
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['aulas.destroy', $aula->id], 'style' => 'display:inline']) !!}
